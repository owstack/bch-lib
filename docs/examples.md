...
var address = new bcccore.PrivateKey(wif).toAddress();
```

## Create a Transaction
```javascript
var privateKey = new bcccore.PrivateKey('L1uyy5qTuGrVXrmrsvHWHgVzW9kKdrp27wBC7Vs6nZDTF2BRUVwy');
var utxo = {
...
var privateKey = new bcccore.PrivateKey('L23PpjkBQqpAF4vbMHNfTZAb3KFPBSawQ7KinFTzz7dxq6TZX8UA');
...
var transaction = new bcccore.Transaction()
    .from(utxo)
    .addData('bcccore rocks') // Add OP_RETURN data
    .sign(privateKey);
```
...
var address = new bcccore.Address(publicKeys, requiredSignatures);
```

## Spend from a 2-of-2 multisig P2SH address
```javascript
var privateKeys = [
  new bcccore.PrivateKey('91avARGdfge8E4tZfYLoxeJ5sGBdNJQH4kvjJoQFacbgwmaKkrx'),
  new bcccore.PrivateKey('91avARGdfge8E4tZfYLoxeJ5sGBdNJQH4kvjJoQFacbgww7vXtT')
];
var publicKeys = privateKeys.map(bcccore.PublicKey);
var address = new bcccore.Address(publicKeys, 2); // 2 of 2

var utxo = {
  "txId" : "153068cdd81b73ec9d8dcce27f2c77ddda12dee3db424bff5cafdbe9f01c1756",
  "outputIndex" : 0,
  "address" : address.toString(),
  "script" : new bcccore.Script(address).toHex(),
  "satoshis" : 20000
};
