...
describe('Address', function() {
  ...
  it('should throw an error because of bad network param', function() {
    (function() {
      return new Address(PKHLivenet[0], 'BAD', 'pubkeyhash');
...
*/
  ...
  var badChecksums = [
    'bitcoincash:qqmq4ua630cqumzt29ml2jmy8gesega95cjctx4j03',
    'bitcoincash:qp3awknl3dz8ezu3rmapff3phnzz95kansf0r3rs4y',
    'bitcoincash:qpmtrcpj2fgwfn7f5fxxg7xrx08nayzquuv62srvq5',
    'bitcoincash:qrz5xl0qmwxj8q7k57cfgn0avfuf86sr85x2056k42'
  ];

  //livenet non-base32
  var nonBase32 = [
    'bitcoincash:qqmq4ua630cqumz129ml2jmy8gesega95cjctx4j02',
    'bitcoincash:qp3awknl3dz8ezu1rmapff3phnzz95kansf0r3rs4x',
    'bitcoincash:qpmtrcpj2fgwfn715fxxg7xrx08nayzquuv62srvq4'
  ];
  ...
  describe('validation', function() {
    ...
    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('bitcoincash:pq7rlg754h903afdtvvy8967zgj5sf5exuwdv458rr', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid livenet address', function() {
      Address.isValid('bitcoincash:pq7rlg754h903afdtvvy8967zgj5sf5exuwdv458rr', 'livenet').should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      Address.isValid('bitcoincash:pq7rlg754h903afdtvvy8967zgj5sf5exuwdv458rr', 'testnet').should.equal(false);
      Address.isValid('bitcoincash:pq7rlg754h903afdtvvy8967zgj5sf5exuwdv458rr', 'regtest').should.equal(false);
    });
    ...
    it('isValid works as expected even after enableRegtest() is called', function() {
      ...
      Address.isValid('bitcoincash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'mainnet').should.equal(true);
      Address.isValid('bchreg:qrjf2q4j0vx7xwqlnzcuy56vk9j9an0z458k0lrw3m', 'regtest').should.equal(true);
      Address.isValid('bchreg:qrjf2q4j0vx7xwqlnzcuy56vk9j9an0z458k0lrw3m', 'testnet').should.equal(true);
      Address.isValid('bchtest:qrzm24wqva0gnvgcsyc0h8tdpgw462mgmc9lef83vw', 'testnet').should.equal(false);
      Address.isValid('bitcoincash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'testnet').should.equal(false);
      Address.isValid('bchtest:qrzm24wqva0gnvgcsyc0h8tdpgw462mgmc9lef83vw', 'mainnet').should.equal(false);
    ...
    it('should not validate if checksum is invalid', function() {
      for (var i = 0; i < badChecksums.length; i++) {
        ...
        should.exist(error);
        error.message.should.match(/Invalid checksum/);
      }
    });
    ...
    it('should not validate on non-base32 characters', function() {
      for (var i = 0; i < nonBase32.length; i++) {
        var error = Address.getValidationError(nonBase32[i], 'livenet', 'pubkeyhash');
        should.exist(error);
        error.message.should.match(/Non-base32/);
      }
    });
