...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = bcccore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(bcccore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(bcccore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: Constants.TESTNET,
        depth: 0,
        parentFingerPrint: 0,
      ...
      bcccore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = bcccore.PublicKey.fromPoint;
      bcccore.PublicKey.fromPoint = function() {
        bcccore.PublicKey.fromPoint = unstubbed;
