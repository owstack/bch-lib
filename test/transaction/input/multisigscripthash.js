...
var MultiSigScriptHashInput = bchLib.Transaction.Input.MultiSigScriptHash;
...
describe('MultiSigScriptHashInput', function() {
  ...
  var address = new Address('bitcoincash:pqv58rd869nsjepmuk4a3hmzefqrffyf5u6z2qh8hl');

  var output = {
    address: 'bitcoincash:pqv58rd869nsjepmuk4a3hmzefqrffyf5u6z2qh8hl',
