...
TransactionSignature.prototype._checkObjectArgs = function(arg) {
  ...
  $.checkArgument(!lodash.isUndefined(arg.outputIndex), 'outputIndex');
  $.checkState(lodash.isNumber(arg.inputIndex), 'inputIndex must be a number');
  $.checkState(lodash.isNumber(arg.outputIndex), 'outputIndex must be a number');
  ...
  $.checkState(lodash.isNumber(arg.sigtype), 'sigtype must be a number');
};
