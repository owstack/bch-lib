...
function UnspentOutput(data) {
  ...
  $.checkArgument(!lodash.isUndefined(data.amount) || !lodash.isUndefined(data.satoshis),
                  'Must provide an amount for the output');
  var amount = !lodash.isUndefined(data.amount) ? new Unit.fromBCH(data.amount).toSatoshis() : data.satoshis;
