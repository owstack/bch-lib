 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more bitcoin cash than the sum of the input amounts
 * @return {string}
 */
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://bcccore.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by bcccore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a bcccore Address object. The
 * same is true for `script`, which can be a string or a bcccore Script.
 *
 ...
 * CheckTransaction in bitcoin cash core.
 */
