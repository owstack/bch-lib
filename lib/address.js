 ...
 *
 * @param {string} str - A string of the bitcoin cash address
 * @param {String|Network=} network - either a Network instance, Constants.LIVENET, or Constants.TESTNET
 * @param {string=} type - The type of address: 'script' or 'pubkey'
 * @returns {Address} A new valid and frozen instance of an Address
 */
 ...
 * Will return a the string representation of the address
 *
 * @returns {string} Bitcoin Cashaddr String
 */
Address.prototype.toCashaddrString = function() {
  return bchaddr.toCashAddress(this.toString());
};
