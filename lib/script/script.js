...
/**
 * A bitcoin cash transaction script. Each transaction's inputs and outputs
...
console.log('buildPublicKeyHashIn');
//console.log('buildPublicKeyHashIn '+ publicKey);
//console.log('buildPublicKeyHashIn '+ signature);
//console.log('buildPublicKeyHashIn '+ sigtype);
  $.checkArgument(signature instanceof Signature || BufferUtil.isBuffer(signature));
  $.checkArgument(lodash.isUndefined(sigtype) || lodash.isNumber(sigtype));
  if (signature instanceof Signature) {
    signature = signature.toBuffer();
...
//console.log('buildPublicKeyHashIn '+ signature);
var x = BufferUtil.concat([
      signature,
      BufferUtil.integerAsSingleByteBuffer(sigtype || Signature.SIGHASH_ALL)
    ]);
console.log('x = '+x);
console.log('publicKey = '+publicKey);
console.log('buffer '+ new PublicKey(publicKey).toBuffer());
